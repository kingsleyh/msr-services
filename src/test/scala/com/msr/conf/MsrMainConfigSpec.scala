...
class MsrMainConfigSpec extends TestKit(ActorSystem()) with FlatSpecLike with BeforeAndAfterAll with ImplicitSender {
  ...
  trait Case {
    val top = TestActorRef(new MsrMainConfig with MainConfig {
